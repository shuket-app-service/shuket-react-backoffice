...
import { getPermissionLevel } from "../../../store/managerAdmin/thunk";
...
export default function ManagerAdminLevelPermission({ dataOpen, handleSetDataOpen, locale }) {
   ...
   async function fetchData() {
      ...
      const response = await dispatch(getPermissionLevel(dataOpen));
   ...
   return (
      <React.Fragment>
         {backdropLoading ? (
            ...
            <Dialog fullWidth maxWidth="lg" open={dataOpen} onClose={handleClose}>
