...
import { filterLocate, headersLocateWithBarcode } from "../Helper/locate";
import { translate } from "../../../../@crema/services/localization/translate";
import { limitType, orderEstType, orderType } from "../Helper/types";
                     ...
                     {rows.map((row) => (
                        <Fragment>
                           <TableRow key={row?.prd_img_code} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                              <TableCell>
                                 <Checkbox  key={row?.prd_img_code}/>
                              </TableCell>
                              <TableCell align="center">{row?.prd_img_code}</TableCell>
