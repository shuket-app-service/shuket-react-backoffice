...
export default function DelvieryAreaJuso({ openJuso, handleCloseJuso, locale }) {
   ...
   return (
      <React.Fragment>
         <Dialog fullWidth maxWidth="md" open={openJuso} onClose={handleClose}>
            <DialogTitle>{translate(locale, filterLocate.titleJuso)}</DialogTitle>
            <DialogContent>
               <Stack direction={"column"} gap={5}>
                  ...
                  {rows.length > 0 ? (
                     ...
                     <div>
                        <b>TIP</b>
                        <div dangerouslySetInnerHTML={{ __html: translate(locale, filterLocate.tipJuso) }}></div>
                     </div>
                  )}
               </Stack>
            </DialogContent>
