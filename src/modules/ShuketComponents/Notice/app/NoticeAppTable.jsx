...
export default function NoticeAppTable({ rows, dataFilter, changeDataFilterDirectly, pageCount, searchCount, handleChangePage, locale }) {
                  ...
                  <TableBody>
                     {rows.map((row, index) => (
                        <TableRow key={row?.mart_code} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                           ...
                           <TableCell align="center">{row?.target_mart} </TableCell>
                           <TableCell align="center">
